                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="single_input">
                                            <select class="wide">
                                                <option data-display="Pilih Pemakaman">Pilih Pemakaman</option>
                                                @if(isset($pemakaman))
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <div class="about_img wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">
                        <img src="/images/assets/about/about.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                            ...
                            <div class="row">
                                <div class="col-lg-11">
                                    <div class="single_testmonial d-flex align-items-center">
                                        <div class="thumb">
                                            <img src="/images/assets/testmonial/author.png" alt="">
