            ...
            <div class="col-md-12">
                ...
                @if(count($cetakPemakamanName)>0)
                    @foreach($cetakPemakamanName as $pemakamanName)
                        <div class="col-md-12">
                            <form action="/IPTM/pemindahan/{{$pemakamanName->pemakaman_id}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <h2> Izin Pemindahan Pada Pemakaman {{$pemakamanName->nama_pemakaman}}</h2>
