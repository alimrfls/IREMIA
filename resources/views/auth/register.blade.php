                ...
                <div class="login-form">
                    ...
                    <form action="{{route('register')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input name="fullname" type="text" class="form-control" placeholder="User Name" value="{{old('fullname')}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="confirmation_password" type="password" class="form-control" placeholder="Password Confirmation">
                        </div>
                        <div class="form-group">
                            <label>ALAMAT</label>
                        ...
                        <div class="checkbox">
                            <label>
                                <input name="terms" type="checkbox"> Menyetujui ketentuan dan kebijakan
                            </label>
                        </div>
                        <button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30">Daftar</button>

                        <div class="register-link m-t-15 text-center">
                            <p>Sudah memiliki akun ? <a href="{{ route('login') }}"> Silahkan masuk disini </a></p>
                        </div>
                    </form>
                </div>
            </div>
