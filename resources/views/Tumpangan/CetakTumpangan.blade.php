                ...
                @if(count($cetakPemakamanName)>0)
                    @foreach($cetakPemakamanName as $pemakamanName)
                        <div class="col-md-12">
                            ...
                            <h2> Izin Tumpangan Pemakaman {{$pemakamanName->nama_pemakaman}}</h2>
                            ...
                            $("#jsonResult").html(function () {
                                ...
                                for(var i=0; i<data.length; i++){
                                    tRow +=
                                        ...
                                        "</td>"+
                                        "<td>" +
                                        "<button class='btn btn-success' onclick='ProsesIPTM("+JSON.stringify(data[i])+")'><i class='fa fa-plus'></i>Tumpangan</button>" +
                                        "</td>"+
                                        "</tr>";
                                }
                                return tRow;
