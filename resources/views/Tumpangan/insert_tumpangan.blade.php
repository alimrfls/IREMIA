            ...
            <div class="col-md-12">
                ...
                @if(count($pemakamanname)>0)
                    @foreach($pemakamanname as $pemakamanName)
                        <div class="col-md-12">
                            <form action="/izinTumpangan/{{$pemakamanName->pemakamanid}}" method="POST"
                                  enctype="multipart/form-data">
                                @csrf
                                <h3> IPTM Tumpangan {{--{{$pemakamanName->namaPemakaman}}--}}</h3>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <strong>Nomor Kartu Keluarga <label style="color: red">*</label></strong>
                                        </div>
                                        <div class="input-group" style="width: 90%">
                                            <div class="input-group-addon"><i class="fa fa-id-badge"></i></div>
                                            <input type="text" name="nomor_kartu_keluarga" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <strong>Nama Lengkap Almarhum/ah Baru <label style="color: red;">*</label></strong>
                                        </div>
                                        <div class="input-group" style="width: 90%">
                                            <div class="input-group-addon"><i class="fa fa-address-book"></i></div>
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <strong>Nomor KTP Almarhum/ah
                                                <label style="color: red">*</label>
                                            </strong>
                                        </div>
                                        <div class="input-group" style="width: 90%">
                                            <div class="input-group-addon"><i class="fa fa-id-badge"></i></div>
                                            <input type="text" name="nomor_ktp_almarhum" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <div class="col-md-6">
                                        <div>
                                            <strong>Nama Lengkap Almarhum/ah Lama <label style="color: red">*</label></strong>
                                        </div>
                                        <div class="input-group" style="width: 90%">
                                            <div class="input-group-addon"><i class="fa fa-address-book"></i></div>
                                            <input type="text" name="nama_almarhum_lama" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div>
                                ...
                                <div class="form-group col-md-12">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group" style="width: 90%">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                            <input type="date" name="masa_berlaku_iptm" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <strong>Nomor Surat Keterangan Kematian Rumah Sakit
                                                <label style="color: red">*</label>
                                            </strong>
                                        </div>
                                        <div class="input-group" style="width: 90%">
                                            <div class="input-group-addon"><i class="fa fa-envelope"></i></div>
                                            <input type="text" name="nomor_sk_kematian_rumah_sakit" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div>
                                            <strong>Nomor Surat Keterangan Kematian Kelurahan
                                                <label style="color: red">*</label>
                                            </strong>
                                        </div>
                                        <div class="input-group" style="width: 90%">
                                            <div class="input-group-addon"><i class="fa fa-envelope"></i></div>
                                            <input type="text" name="nomor_sk_kematian_kelurahan" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <div class="col-md-6">
                                        <div>
                                            <strong>Nomor Surat Pengantar RT/RW <label style="color: red">*</label></strong>
                                        </div>
                                        <div class="input-group" style="width: 90%">
                                            <div class="input-group-addon"><i class="fa fa-envelope"></i></div>
                                            <input type="text" name="nomor_surat_rtrw" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div>
                                            <strong>Tanggal Surat Pengantar RT/RW
                                                <label style="color: red">*</label>
                                            </strong>
                                        </div>
                                        <div class="input-group" style="width: 90%">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                            <input type="date" name="tanggal_surat_rtrw" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group" style="width: 90%">
                                            <div class="input-group-addon"><i class="fa fa-envelope"></i></div>
                                            <input type="text" name="nomor_kehilangan_kepolisian" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div>
                                        ...
                                        <div class="input-group" style="width: 90%">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                            <input type="date" name="tanggal_kehilangan_kepolisian"     class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <strong> Scan Foto Copy / Asli KTP Almarhum
                                            <label style="color: red">*</label>
                                        </strong>
                                        <input name="file_ktp_almarhum" type="file" class="form-control-file">
                                    </div>
                                </div>

                                <div class="form-group col-md-12">
                                    <div class="col-md-6">
                                        <strong> Scan Surat Kematian Rumah Sakit/Puskesmas</strong>
                                        <input name="file_sk_kematian_rumah_sakit" type="file" class="form-control-file">
                                    </div>
                                    <div class="col-md-6">
